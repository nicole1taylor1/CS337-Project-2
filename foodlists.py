## This file contains list of ingredients, measurements, etc. 
## It was adapted from here: https://github.com/kbrohkahn/recipe-parser/tree/master

allIngredients = {
        "dairyIngredients": ['buttermilk', 'cottage', 'cream', 'creamer', 'creamy', 'creme', 'ghee', 'half-and-half', 'milk', 'yogurt'],
...
preparations = ['baked', 'beaten', 'blanched', 'boiled', 'boiling', 'boned', 'breaded', 'brewed', 'broken', 'chilled',
		...
		'split', 'squeezed', 'stemmed', 'stewed', 'strained',  'thawed',  'tied', 
		'toasted', 'torn', 'trimmed', 'wrapped', 'vained',  'washed', 'zested', 'wedged',
